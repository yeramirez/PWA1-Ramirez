...
// variables
    ...
    var name = "Yanely", course = "PWA-1", month = 1;
    ...
    console.log("Name: " + name3+ "Course Title: "+ course3+ "Month: "+month3);
    document.write("<br>"+"Name: " + name3+ " Course Title: "+ course3+ " Month: "+month3);
...
// string (definition, concatenation, escape character)
    ...
    //basic string
    var name4 = "Beyonce Knowles";
    var course4 = "Partition";
    var month4 = 1;

    console.log("Name: " + name4+ "Course Title: "+ course4+ "Month: "+ month4);
    document.write("<br>"+"Name: " + name4+ " Course Title: "+ course4+ " Month: "+month4);
    ...
    var testString = "Yanely needs some \"quotes\" up in here";
...
// numbers (definition, concatenation +, math, numbers & strings)
    ...
    var counter = 10;
    console.log("Yanely's Basic Math Counter works: " + counter + 1);
    document.write("<br>" + "Yanely's Basic Math Counter works: " , counter + 1);


    //basic math

    var num = 10;
    console.log("Yanely's Basic Math Counter works: " + num);
    document.write("<br>" + "Yanely's Basic Math Counter works: " + num);
    ...
    myNum--;
    console.log("And myNum -- decreases to " , myNum);
    document.write("<br>" + "And myNum -- decreases to " , myNum);
    ...
    console.log("Near Line 158, Counter-- results in: ", num--);
    document.write("<br>" + "Near Line 158, Counter-- results in: ", num--);
